...
\ThisULCornerWallPaper{1.02}{img/plasm-cover.png}
...
\centerline{Revision Nov-12-2012}
...
This free textbook, written by Dr. Pavel Solin and Dr. Alberto Paoluzzi, 
is provided as a courtesy to NCLab users. At a slow pace
...
browser using PLaSM (Programming Language of Solid Modeling), a simple and 
elegant scripting language. In order to work with PLaSM, your web browser needs 
to have WebGL set up properly.\\[2mm]

\noindent
{\bf About the Authors}\\[2mm]
Dr. Pavel Solin is Professor of Computational Science at the University of Nevada, Reno. 
He is an expert in mathematical and computer modeling and scientific computing. 
Dr. Alberto Paoluzzi is Professor of Computer Graphics and CAD Design at the 
University of Rome in Italy, leader of the PLaSM project, and author of the famous 
monograph {\em Geometric Programming for Computer Aided Design, Wiley, 2003}.\\[2mm]
...
thousands of readers worldwide. Instructions for contributors can be found 
below.\\[2mm]
...
in a public Git repository {\tt nclab-textbook-plasm} at Github (http://github.com). \\[2mm]

\noindent
{\bf How to Contribute (for all others)}\\[2mm]
\noindent
We will gladly accept new interesting exercises for PLaSM, as well as
